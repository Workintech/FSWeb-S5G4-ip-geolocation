...
function geoLocation(obje) {
  var cardOlustur = document.createElement("div");
  var imgOlustur = document.createElement("img");
  var cardInfo = document.createElement("div");
  var ipOlustur = document.createElement("h3");
  var ulkeOlustur = document.createElement("p");
  var enlemBoylam = document.createElement("p");
  var sehirOlustur = document.createElement("p");
  ...
  ulkeOlustur.textContent = "".concat(obje.ülke, " (").concat(obje.ülkeKodu, ")");
...
var cardsAl = document.querySelector(".cards");
_axios.default.get("https://apis.ergineer.com/ipgeoapi/88.251.21.205").then(function (response) {
